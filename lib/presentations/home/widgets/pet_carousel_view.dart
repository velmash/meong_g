...
import 'package:meong_g/presentations/home/widgets/pet_add_card.dart';
import 'package:meong_g/presentations/home/widgets/pet_info_card.dart';
      ...
      itemBuilder: (context, index) {
        return Padding(
          padding: EdgeInsets.only(
            left: index == 0 ? 0 : 4,
            right: index == allCards.length - 1 ? 0 : 4,
          ),
